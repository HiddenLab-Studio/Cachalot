    ...
    return (
        ...
        <ClassInfoUserWrapper>
            ...
            {userInfos != null && myAdmin != null && professeur === true && (
                <>
                    <Draggable defaultDragHandle=".drag-handle">
                        <div className={`fixed rounded-lg overflow-hidden my-3 bg-gray-100 border-2 border-gray-300 shadow-md w-64 drag-handle`}
                            style={{ left: position.x, top: position.y }}>


                            <div
                                className="w-full h-20 bg-cover bg-no-repeat bg-center"
                                style={{
                                    backgroundImage: `url("https://media1.giphy.com/media/13tLbNypHGL4Zy/giphy.gif?cid=ecf05e470agoo3aqznd5dq0cclwhyi7seevfueafqe50omnv&ep=v1_gifs_search&rid=giphy.gif&ct=g")`,
                                }}
                            ></div>
                            <div className="flex pl-2 -mt-10">
                                <a href={`/profile/${userInfos.username}`} className="relative group">
                                    <img
                                        src={userInfos.photo}
                                        className="w-20 h-20 rounded-full border-solid border-gray-100 border-4 hover:opacity-90 transition-opacity"
                                        alt="User Profile"
                                    />
                                </a>
                            </div>
                    ...
                    <Draggable defaultDragHandle=".drag-handle">
                        <div className={`fixed right-72 top-${position.y} rounded-lg overflow-hidden my-3 bg-gray-100 border-2 border-gray-300 shadow-md w-64`}
                            ...
                            <div
                                className="w-full h-20 bg-cover bg-no-repeat bg-center"
                                style={{
                                    backgroundImage: `url("https://media2.giphy.com/media/jSuu6dQWhSEQE/giphy.gif?cid=ecf05e47wmlnruw2sdb70vs6xgyq4frxqk20ws39qtp2sxy2&ep=v1_gifs_search&rid=giphy.gif&ct=g")`,
                                }}
                            ></div>
                            <div className="flex pl-2 -mt-10">
                                <a href={`/profile/${userInfos.username}`} className="relative group">
