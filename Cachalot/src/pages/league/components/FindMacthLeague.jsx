    ...
    <FindMatchContainerWrapper>
      <div className="flex flex-col md:flex-row items-center justify-center h-screen overflow-y-hidden">
        ...
        <div className="flex flex-col items-center bg-white rounded-lg border-2 border-gray-200 shadow-md p-8 space-y-4">
          ...
          <h2 style={{ fontFamily: "'DIN Round Pro bold', sans-serif", }} className="text-2xl mb-2 text-gray-700">{ranked}</h2>
          <div className="flex space-x-4">
            <button
              className={`${selectedDiscipline === "french" ? "bg-gray-300 border-2 border-green-500" : "bg-gray-100 hover:bg-gray-300 shadow-md border-2"
            ...
            >
              ...
              <span style={{ fontFamily: "'DIN Round Pro Medi', sans-serif" }}>Français</span>
            </button>
            <button
              className={`${selectedDiscipline === "math" ? "bg-gray-300 border-2 border-green-500" : "bg-gray-100 hover:bg-gray-300 shadow-md border-2"
                } py-2 px-4 rounded-md w-40 flex items-center flex-col`}
              onClick={() => handleDisciplineChange("math")}
            >
              <img src="../../../../static/img/icons/math.png" alt="Math" className="p-0" />
              <span style={{ fontFamily: "'DIN Round Pro Medi', sans-serif" }}>Mathématiques</span>
            </button>
          </div>
